> an advanced, specific prompt engineering framework / technique for retrieving facts from an external knowledge base to optimise LLM responses on the most accurate and up-to-date information. 
